...
<li class="breadcrumb-item active">Appointments</li>
                ...
                $id = $_GET['id'];
                $query = "SELECT * FROM cust_ext_img";
                $ex = mysqli_query($conn, $query);
                $data = mysqli_fetch_array($ex);
                ?>
                <form action="ext_update.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        <input type="hidden" name="cid" value="<?php echo $id ?>">
                        <label class="col-form-label col-md-2">Interior Image</label>
                        <div class="col-md-10">
                            <input class="form-control" name="ext_img" value="<?php echo $data['ext_img'] ?>" type="file">
                        </div>
                    </div>
