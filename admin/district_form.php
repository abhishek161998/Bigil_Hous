                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="d-flex align-items-center">
                                <h5 class="page-title">Add District</h5>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="district_list_insert.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">State</label>
                                        <div class="col-md-10">
                                            <select name="state" class="form-control" id="categorySelect" required>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">District Name</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="district" placeholder="Type Name" required>
                                        </div>
                                    </div>
