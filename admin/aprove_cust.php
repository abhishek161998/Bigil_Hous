...
<li class="breadcrumb-item active">Appointments</li>
        ...
        <table class="table" id="myTable">
          ...
          while ($row = mysqli_fetch_array($exe)) {
            ...
            // $res1 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM customer "));
          ...
          ?>
            <tr>
              ...
              <td class="text-right d-flex">
                ...
                <a href="photoedit.php?id=<?php echo $row['id'] ?>" class="btn btn-success"> See Images </a>

              </td>
              <td>
                <a href="delet.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a>
