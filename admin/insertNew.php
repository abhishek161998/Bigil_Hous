...
$query = "INSERT INTO customer(`state`, `dist`, `city`, `area`, `sub_area`, `address`, `catagory`, `type`, `avail`, `price`) VALUES ('$state','$dist','$city','$area','$sub_area ','$address','$catagory ','$type','$avail','$price ')";
...
for ($i = 0; $i < $total_count; $i++) {
    ...
    //         $insertquery = "INSERT INTO `int_img`( `img_id`,`int_img`) VALUES ('$program_id','$file_name')";
    //         // echo $insertquery . "<br>";
...
for ($i = 0; $i < $total_count; $i++) {
    ...
    //         $insertquery = "INSERT INTO `ext_img`( `img_id`,`ext_img`) VALUES ('$program_id','$file_name')";
    //         echo $insertquery . "<br>";
