                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right d-flex">
                                                        ...
                                                        <a href="contact_msg_delet.php?id=<?php echo $row['id']   ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a>
