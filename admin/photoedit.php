                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h5 class="page-title">Edit Photos</h5>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-right d-flex">
                                ...
                                <a href="deletePhoto.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a>
                                ...
                                <!-- <a href="aprove_edit.php?id=<?php echo $row['id']   ?>" class="btn btn-sm btn-white text-success mr-2 d-flex"><i class="far fa-edit mr-1"></i> Edit</a> -->
                            </td>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-right d-flex">
                                ...
                                <a href="extdeletePhoto.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a>
