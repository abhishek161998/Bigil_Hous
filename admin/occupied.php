        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h5 class="page-title">Occupied</h5>
                ...
                <table class="table" id="myTable">
                    ...
                    $query = "SELECT * FROM   customer where avail='occupied'";
                    ...
                    ?>
                        <tr>
                            ...
                            <!-- <a href="occupie_delet.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a> -->

                            <!-- <a href="occupie_edit.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-white text-success mr-2 d-flex"><i class="far fa-edit mr-1"></i> Edit</a> -->
                            <!-- </td> -->
