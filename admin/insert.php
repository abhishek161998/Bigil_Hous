...
$query = "INSERT INTO `customer`(`cust_id`, `state`, `dist`, `city`, `area`, `sub_area`, `address`, `catagory`, `type`, `avail`, `price`) VALUES ('$custid','$state','$dist','$city','$area','$sub_area ','$address','$catagory ','$type','$avail','$price ')";
