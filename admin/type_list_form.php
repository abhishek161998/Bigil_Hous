					...
					<div class="row align-items-center">
						<div class="col-md-12">
							<div class="d-flex align-items-center">
								<h5 class="page-title">Add Types</h5>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<form action="type_list_insert.php" method="POST" enctype="multipart/form-data">
									<div class="form-group row">
										<label class="col-form-label col-md-2">Category</label>
										<div class="col-md-10">
											<select name="catagory" class="form-control" id="categorySelect" required>
									...
									<div class="form-group row">
										<label class="col-form-label col-md-2">Type Name</label>
										<div class="col-md-10">
											<input type="text" class="form-control" name="type" placeholder="Type Name" required>
										</div>
									</div>
