                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h5 class="page-title">State List</h5>
...
<li class="breadcrumb-item active">Appointments</li>
                        ...
                        <div class="col-auto text-right">
                            <a href="state_form.php" class="btn btn-primary"> Add State </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        $query = "SELECT * FROM  state where status='1'  order by id desc ";
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right d-flex">
                                                        ...
                                                        <a href="state_list_dlt.php?id=<?php echo $row['id']   ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a> 
