...
<li class="breadcrumb-item active">Appointments</li>
                        ...
                        <div class="col-auto text-right">
                            <a href="category_list_form.php" class="btn btn-primary"> Add Category </a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right d-flex">
                                                        ...
                                                        <!-- <a href="category_list_dlt.php?id=<?php echo $row['id']   ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a> -->
