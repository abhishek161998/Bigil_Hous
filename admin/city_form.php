                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="d-flex align-items-center">
                                <h5 class="page-title">Add City</h5>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="city_list_insert.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control" name="district" id="result_data" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="city" placeholder="Type Name" required>
                                        </div>
                                    </div>
