                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h5 class="page-title">Customer's Registration Details</h5>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        $query = "SELECT * FROM   customer_login  order by id desc ";
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right d-flex">
                                                        ...
                                                        <a href="cust_login_delet.php?id=<?php echo $row['id']   ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a>

                                                        <a href="login_edit.php?id=<?php echo $row['id']   ?>" class="btn btn-sm btn-white text-success mr-2 d-flex"><i class="far fa-edit mr-1"></i> Edit</a>
