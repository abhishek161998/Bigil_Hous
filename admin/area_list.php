                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h5 class="page-title">Area List</h5>
...
<li class="breadcrumb-item active">Appointments</li>
                        ...
                        <div class="col-auto text-right">
                            <a href="area_form.php" class="btn btn-primary"> Add Area</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        $query = "SELECT * FROM  area where status='1'  order by id asc ";
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right d-flex">
                                                        ...
                                                        <a href="area_list_delet.php?id=<?php echo $row['id']   ?>" class="btn btn-sm btn-white text-danger mr-2 d-flex"><i class="far fa-trash-alt mr-1"></i>Delete</a>
