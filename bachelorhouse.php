...
<body>
    ...
    $query = "SELECT COUNT(*) FROM   customer where catagory='22' ";
  ...
  <div class="apartments-area four bg-gray-color">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" id="popular-apartment" class="tab-pane fade in active">
                                <div class="row">
                                    ...
                                    include "database/db_con.php";
                                     if($total>0){
                                    $query = "SELECT * FROM customer where catagory ='22' ";
                                    $exe = mysqli_query($conn, $query);
                                    while ($row = mysqli_fetch_array($exe)) {
                                        ...
                                        // $res1 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM cust_ext_img WHERE img_id = '" . $row['id'] . "'"));
                                           ...
                                           <a href="apartment-single.php?id=<?php echo $row['id']   ?>">
                                            ...
                                            <div class="text-content">
                                                <div class="top-content">
                                                    <h3>
                                                         <a href="apartment-single.php?id=<?php echo $row['id']   ?>"><?= $result['catagory_name']?></a>
                                                    </h3>
                                                   
                                                </div><!-- /.top-content -->
                                                <div class="bottom-content clearfix">
                                                    <div class="meta-bed-room">
                                                        <i class="fa fa-bed"></i> <?= $result1['type']?>
                                                    </div>
    ...
    <script>
        const popop = () => {
            swal("For more query", "Call Us 1236547890");
        }
    </script>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" id="popular-apartment" class="tab-pane fade in active">
                                <div class="row">
                                    ...
                                    <?php
                                    include "database/db_con.php";
                                    $query = "SELECT * FROM admin where catagory='BachelorHouse'";
                                    $exe = mysqli_query($conn, $query);
                                    while ($row = mysqli_fetch_array($exe)) {
                                    ?>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-6">
                                            <div class="apartments-content">
                                                <div class="image-content">
                                                    <a onclick="popop()">
                                                        <img src="upload/exterior/<?php echo $row['ext_img'] ?>" alt="apartment" />
                                                    </a>
                                                </div><!-- /.image-content -->
                                                ...
                                                <div class="text-content">
                                                    ...
                                                    <div class="bottom-content clearfix">
                                                        <div class="meta-bed-room">
                                                            <i class="fa fa-bed"></i> <?php echo $row['type']; ?>
