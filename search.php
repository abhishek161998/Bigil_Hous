...
<!-- Mirrored from htmlguru.net/house-rent/apartment.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Sep 2021 18:16:38 GMT -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="page-description">All House List</p>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->
    </div><!-- /.page-header -->
...
extract($_GET);
    $query = "SELECT COUNT(*) FROM   customer area='$area' and city ='$city' and catagory='$category' ";
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" id="popular-apartment" class="tab-pane fade in active">
                                <div class="row">
                                    ...
                                    // $city = 'Bhubaneswar';
                                    // $category = 'Apratment';
                                    $query = "SELECT * FROM customer where area='$area' and city ='$city' and catagory='$category'";
                                    $exe = mysqli_query($conn, $query);
                                    // print_r($query);

                                    while ($row = mysqli_fetch_array($exe)) {
                                        $result = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM customer "));

                                        $result1 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM type WHERE id = '" . $result['type'] . "'"));
                                        // print_r($_GET);
                                        $res = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM category WHERE id = '" . $result['catagory'] . "'"));
                                        $res1 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM area WHERE id = '" . $row['area'] . "'"));
                                                                                  $select = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM cust_ext_img where img_id='".$row['id']."' "));
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-6">
                                            <div class="apartments-content">
                                                <div class="image-content">
                                                    <a href="apartment-single.php?id=<?php echo $result['id']   ?>">
                                                 <?php
                                                        if($select['ext_img']!=''){
                                                        ?>

                                                        
                                                        <img src="upload/exterior/<?php echo $select['ext_img'] ?>" alt="apartment" />
                                                        <?php
                                                        } else {
                                                        ?>
                                                        <img src="upload/exterior/No_Image.jpg" alt="noimage" />
                                                        <?php
                                                        }
                                                        ?>
                                                    </a>
                                            ...
                                            <div class="text-content">
                                                ...
                                                <div class="bottom-content clearfix">
                                                    <div class="meta-bed-room">
                                                        <i class="fa fa-bed"></i> <?php echo $result1['type']; ?>
                         ...
                         <?php }}else{
                                 echo '<h2 style="color:#222831;background-color:#F38181;text-align:center">'.'&#9962 Property Not  Found '.'</h2>';
                            }?>
                            <!-- /.col-md-4 -->
    ...
    <script>
        const popop = () => {
            swal("For more query", "CALL US - +91-9668630222");
        }
    </script>
